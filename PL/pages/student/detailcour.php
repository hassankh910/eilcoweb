        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    ?>
                    <div class="cours">
                        <h3 style="margin-top:2% ; margin-left:2%">Cours : <?php echo $cours->getNom(); ?></h3>
                        <h4 style="margin-top:2% ; margin-left:2%">Enseignant: <?php $prof = getProfName($cours->getProf_id());
                                                                                echo strtoupper($prof->getNom()) . " " . ucfirst($prof->getPrenom()); ?></h4>
                        <h5 style="margin-top:2% ; margin-left:2%">Address mail : <?php echo $prof->getEmail_universitaire(); ?></h5>
                    </div>
                    <table class="table">
                        <thead>
                            <tr>
